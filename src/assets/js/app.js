                ...
                (e < 1025 && 767 < e
                    ? (document.body.classList.remove("twocolumn-panel"),
                      "twocolumn" == sessionStorage.getItem("data-layout") &&
                          (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), v(), A(), f()),
            ...
            switch (e["data-layout"]) {
                ...
                default:
                    "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout")
                        ...
                        : "twocolumn" == sessionStorage.getItem("data-layout")
                        ? (T("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn"))
                        : "semibox" == sessionStorage.getItem("data-layout") && (T("data-layout", "semibox"), sessionStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), k("semibox"));
            }
                    ...
                    document.documentElement.setAttribute(a, t.value),
                        ...
                        "data-layout" == a &&
                            ("vertical" == t.value
                                ...
                                : "twocolumn" == t.value
                                ? (k("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), v(), A(), f(), feather.replace())
                                : "semibox" == t.value &&
                                  (k("semibox"),
